...
public class AtomOffsetFeedEndpointWithNamedUpperOffsetTest {
    ...
    public void setUp() throws Exception {
        ...
        endpoint = new AtomOffsetFeedEndpoint.WithNamedUpperOffset<>(
    ...
    public void can_read_first_page() throws Exception {
        stubFor(get(urlPathEqualTo("/0/nyere/2"))
    ...
    public void can_read_last_page() throws Exception {
        stubFor(get(urlPathEqualTo("/siste/2"))
            .willReturn(aResponse()
                .withStatus(200)
        ...
        Assertions.assertThat(endpoint.getLastPage()).hasValueSatisfying(page -> {
            ...
            Assertions.assertThat(page.getLocation().getDirection()).isEqualTo(AtomOffsetFeedLocation.Direction.BACKWARD);
            Assertions.assertThat(page.getPreviousLocation()).contains(
                new AtomOffsetFeedLocation(98, AtomOffsetFeedLocation.Direction.BACKWARD)
            );
            Assertions.assertThat(page.getNextLocation()).contains(
                new AtomOffsetFeedLocation(100, AtomOffsetFeedLocation.Direction.FORWARD)
            );
            Assertions.assertThat(page.getEntries())
                .extracting(AtomOffsetFeedEntry::getLocation)
                .extracting(AtomOffsetFeedLocation::getOffset)
    ...
    public void can_read_forward() throws Exception {
        stubFor(get(urlPathEqualTo("/50/nyere/2"))
            .willReturn(aResponse()
                .withStatus(200)
        ...
        assertThat(endpoint.getPage(
            ...
            assertThat(page.getPreviousLocation()).contains(
                new AtomOffsetFeedLocation(49, AtomOffsetFeedLocation.Direction.BACKWARD)
            );
            assertThat(page.getNextLocation()).contains(
                new AtomOffsetFeedLocation(51, AtomOffsetFeedLocation.Direction.FORWARD)
            );
    ...
    @Test
    public void can_read_page_backward() throws Exception {
        stubFor(get(urlPathEqualTo("/50/eldre/2"))
            .willReturn(aResponse()
                .withStatus(200)
        ...
        assertThat(endpoint.getPage(
            ...
            assertThat(page.getPreviousLocation())
                .contains(new AtomOffsetFeedLocation(48, AtomOffsetFeedLocation.Direction.BACKWARD));
            assertThat(page.getNextLocation())
                .contains(new AtomOffsetFeedLocation(50, AtomOffsetFeedLocation.Direction.FORWARD));
            assertThat(page.getEntries())
                .extracting(AtomOffsetFeedEntry::getLocation)
                .extracting(AtomOffsetFeedLocation::getOffset)
